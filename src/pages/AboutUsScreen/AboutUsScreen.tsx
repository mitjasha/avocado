      ...
      <div className="container">
        ...
        <div className="about__us__container">
          <span className="about__us__text">
            ...
            such an application, opening which you would like to come back
            again.
          </span>
          ...
          <span className="about__us__text">
            Start today! Taking care of yourself is easier than it seems. We
            wish you success in achieving your goal on the path of a healthy
            lifestyle!
          </span>
